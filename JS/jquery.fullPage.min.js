...
(function(a) {
    a.fn.fullpage = function(c) {
        ...
        function x(b, d) {
            ...
            else c = "top", f = a.fn.fullpage.moveSectionUp; if (0 < d.length)
        ...
        function Y(b) {
            b.addClass("fp-table").wrapInner('<div class="fp-tableCell" style="height:' + Z(b) + 'px;" />')
        }
        ...
        function J(b, c) {
            ...
            var e = isNaN(b) ? a('[data-anchor="' +
                b + '"]') : a(".fp-section").eq(b - 1);
            b === v || e.hasClass("active") ? $(e, c) : r(e, function() {
                $(e, c)
            })
        }
        ...
        function ia() {
            ...
            for (var f in e) void 0 !== a.style[f] &&
                (a.style[f] = "translate3d(1px,1px,1px)", c = window.getComputedStyle(a).getPropertyValue(e[f]));
        ...
        c.continuousVertical && (c.loopTop || c.loopBottom) && (c.continuousVertical = !1, console && console.log &&
        ...
        a.fn.fullpage.setAllowScrolling = function(b) {
            if (b) {
                if (a.fn.fullpage.setMouseWheelScrolling(!0), K || ba) MSPointer = aa(), a(document).off("touchstart " + MSPointer.down).on("touchstart " +
                    MSPointer.down, fa), a(document).off("touchmove " + MSPointer.move).on("touchmove " + MSPointer.move, ea)
            } else if (a.fn.fullpage.setMouseWheelScrolling(!1), K || ba) MSPointer = aa(), a(document).off("touchstart " + MSPointer.down), a(document).off("touchmove " + MSPointer.move)
        };
        ...
        a(".fp-section").each(function(b) {
            ...
            c.scrollOverflow ? (g.hasClass("fullpage-used") && L(), a(window).on("load", L)) : a.isFunction(c.afterRender) && c.afterRender.call(this);
        ...
        a(document).keydown(function(b) {
            ...
            if (document.getElementsByClassName('lightboxOverLay').length == 0 || document.getElementsByClassName('lightboxOverLay')[0].style.display === 'none') {
        ...
        a(window).resize(function() {
            K ? a.fn.fullpage.reBuild() : (clearTimeout(ca), ca = setTimeout(a.fn.fullpage.reBuild, 500))
        });
        ...
        a.fn.fullpage.destroy = function(b) {
            ...
            a(window).off("scroll", M).off("hashchange", V);
            a(document).off("click",
                "#fp-nav a").off("mouseenter", "#fp-nav li").off("mouseleave", "#fp-nav li").off("click", ".fp-slidesNav a").off("mouseover", c.normalScrollElements).off("mouseout", c.normalScrollElements);
